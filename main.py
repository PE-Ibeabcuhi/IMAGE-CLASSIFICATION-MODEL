...
background_color = "#381A14"  # Set your desired background color
center_image_path = "/Users/user/Desktop/Test Folder/testimage7.jpeg"  # Replace with the path to your center image
